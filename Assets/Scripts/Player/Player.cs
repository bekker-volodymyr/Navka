...
public class Player : MonoBehaviour, IMoveable, IDamageable, IAttack, IInteract
{
    ...
    {
        // TODO: застосуванн€ п≥дсилень та послаблень показника шкоди
    ...
    {
        // TODO: застосуванн€ п≥дсилень та послаблень дл€ показника шкоди
    ...
    private IEnumerator HungerCountdown()
    {
        while(CurrentHunger > 0)
        {
            ...
            // TODO: «астосувати послабленн€/посиленн€
